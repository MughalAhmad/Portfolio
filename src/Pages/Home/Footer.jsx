  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
        <img src="./img/logo.png" alt="Logoipsum" style={{width:"100px"}} />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/mughal.ahmad.792?mibextid=LQQJ4d"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/mughalahmad/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
